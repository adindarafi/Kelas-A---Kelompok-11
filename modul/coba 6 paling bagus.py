...
# Nama file default
file_siswa = 'D:\\projecta\\data_siswa.xlsx'
...
class AplikasiSiswa:
    def __init__(self, root):
        ...
        try:
            self.bg_image_login = ImageTk.PhotoImage(Image.open("D:/projecta/background login.jpg").resize((1280, 725)))
            self.bg_image_input_id = ImageTk.PhotoImage(Image.open("D:/projecta/background id.jpg").resize((1280, 725)))
            self.bg_image_input_data = ImageTk.PhotoImage(Image.open("D:/projecta/background data siswa.jpg").resize((1280, 725)))
            self.bg_image_tabel_data = ImageTk.PhotoImage(Image.open("D:/projecta/background tabel.jpg").resize((1280, 725)))
